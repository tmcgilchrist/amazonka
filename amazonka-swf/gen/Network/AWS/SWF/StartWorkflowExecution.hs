...
data StartWorkflowExecutionResponse a = StartWorkflowExecutionResponse'
...
startWorkflowExecutionResponse
    ...
    -> StartWorkflowExecutionResponse (a)
...
swersRunId :: Lens' (StartWorkflowExecutionResponse (a)) (Maybe Text)
swersRunId = lens _swersRunId (\ s a -> s{_swersRunId = a});

-- | The response status code.
swersResponseStatus :: Lens' (StartWorkflowExecutionResponse (a)) Int
