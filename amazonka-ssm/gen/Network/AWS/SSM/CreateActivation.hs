...
data CreateActivationResponse a = CreateActivationResponse'
...
carsActivationId :: Lens' (CreateActivationResponse (a)) (Maybe Text)
carsActivationId = lens _carsActivationId (\ s a -> s{_carsActivationId = a});

-- | The code the system generates when it processes the activation. The activation code functions like a password to validate the activation ID.
carsActivationCode :: Lens' (CreateActivationResponse (a)) (Maybe Text)
carsActivationCode = lens _carsActivationCode (\ s a -> s{_carsActivationCode = a});

-- | The response status code.
carsResponseStatus :: Lens' (CreateActivationResponse (a)) Int
